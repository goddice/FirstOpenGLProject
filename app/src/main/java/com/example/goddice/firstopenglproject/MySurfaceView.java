...
class MySurfaceView extends GLSurfaceView 
{
	...
	public class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void initShaders()
        {
            ...
            GLES20.glUniform2fv(updateProgram_delta_handler[0], 1, textureDelte, 0);
            GLES20.glUniform2fv(updateProgram_delta_handler[1], 1, textureDelte, 0);
        ...
        public void dropAtFinger(MotionEvent e, float radius, float strength)
        {
            ...
            float dropPosition[] = {(2 * e.getX() - (float)backgroundWidth) / (float)longestSide, ((float)backgroundHeight - 2 * e.getY()) / (float) longestSide};
            GLES20.glViewport(0, 0, resolution, resolution);
            ...
            GLES20.glEnableVertexAttribArray(0);
            GLES20.glUniform2fv(dropProgram_center_handler, 1, dropPosition, 0);
